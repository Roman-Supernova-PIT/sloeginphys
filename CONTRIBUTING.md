Contributing to roman_snpit_sloeginphys
================================================
...
system and the Python, NumPy, and `roman_snpit_sloeginphys` versions you are using.

Contributing Code and Documentation
-----------------------------------

So you are interested in contributing to the roman_snpit_sloeginphys Project?  Excellent!
...
from GitHub users' forks of roman_snpit_sloeginphys If you are new to this
