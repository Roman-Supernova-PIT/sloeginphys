...
def avefnu(sed, band):
    ...
    #     print(f"Bandpass {band.name} is entirely too blue")
    # elif band.wmin > sed.wmax:
    #     print(f"Bandpass {band.name} is entirely too red")
    # elif (sed.wmin > band.wmin) or (sed.wmax < band.wmax):
    #     print(f"Bandpass {band.name} does not cover full range of sed")
    # else:
